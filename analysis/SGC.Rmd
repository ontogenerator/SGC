...
Due to pregnancy after the retest, one female had to be replaced with another individual, in order to keep group sizes constant. As the replacement female had already participated in a complete experimental run, its data in the new social group were only used to calculate the group means, but not individually analyzed.

## (e) Behavioral traits

### Agonistic behavior

Individual agonistic behavior was assessed by quantifying how often an individual chased others away from artificial flowers.
These chasing events were indicated by a special sequence of events automatically recorded by the experimental system [@wintergerst_sex-dependent_2021].
